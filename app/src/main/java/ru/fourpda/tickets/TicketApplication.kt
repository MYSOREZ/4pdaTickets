...
class TicketApplication : Application() {
    ...
    override fun onCreate() {
        ...
        // Сбрасываем дедупликатор при новом запуске приложения
        // Это позволит показать все невыполненные тикеты после перезапуска
        TicketNotifyDeduper.clearOnFirstLaunch(this)
